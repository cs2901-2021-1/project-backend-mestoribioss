...
// 	@GetMapping("/cursos")
//     public ResponseEntity<Object> executeQueryCourses() throws SQLException {
//         try {
...
//     public ResponseEntity<Object> executeQueryClassrooms() throws SQLException {
//         try {
//             Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@coreqa4.cl2cyff2cklb.us-west-2.rds.amazonaws.com:1521:coreqa4", "desarrollo", "qad3vLE7Uk0110xor");
//             Statement statement = connection.createStatement();
