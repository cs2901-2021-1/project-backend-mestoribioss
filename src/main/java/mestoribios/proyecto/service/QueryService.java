...
public class QueryService {
    ...
    public List<CourseResponse> executeQueryCourses() throws SQLException {
        try {
            Connection connection = DriverManager.getConnection(env.getProperty("datasource.url"), env.getProperty("second.datasource.username"), env.getProperty("second.datasource.password"));
